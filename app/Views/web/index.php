    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?= base_url('img/club.jpg') ?>" class="d-block w-100" alt="Gambar 1" width="100%" height="450px">
            </div>
        </div>
        <br>
        <div class="container">
            <h2>Selamat Bergabung di Club Motor PBB</h2>
            <p>Club Motor PBB menawarkan lebih dari sekadar hobi; kami menyediakan komunitas yang solid, teknologi terkini, dan didukung oleh anggota yang berpengalaman. Di sini, Anda akan menemukan kesempatan untuk menjalin hubungan, berbagi pengetahuan, dan merasakan kegembiraan berkendara tidak hanya dalam aspek teknis tetapi juga dalam hal persaudaraan dan petualangan. Kami berkomitmen untuk memberikan pengalaman yang berkesan dan mendalam, mempersiapkan Anda untuk menikmati setiap momen di jalanan dengan kepercayaan dan pengetahuan yang diperlukan untuk mengeksplorasi dunia luar dengan semangat</p>
        </div>
        <div class="feature-section">
            <div class="container">
